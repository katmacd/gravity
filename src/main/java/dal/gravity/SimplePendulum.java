...
public class SimplePendulum extends AbstractPendulum {
	 ...
	 * (0<=theta0<=pi/6)
	 */
	public SimplePendulum(double inLength, double inMass, double inTheta0, GravityModel daGM) {
		super(inLength, inMass, inTheta0, daGM.getGravitationalField(), daGM);
