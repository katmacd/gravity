...
public class RegularPendulum extends AbstractPendulum {
    ...
    public GravityModel daGM;

    /**
     * Creates a new Pendulum instance 
     */
    public RegularPendulum (double inLength, double inMass, double inTheta0, 
		     double inDelta, double inDiss, GravityModel daGM) {
	super (inLength, inMass, inTheta0, inDelta, daGM);
	delta=inDelta;
	dissipation = inDiss;
	lastVel = 0;
    ...
    /*public RegularPendulum (double inLength, double inMass, double inTheta0, 
		     double inDelta) {
	this (inLength, inMass, inTheta0, inDelta, 0, daGM);
    }*/
